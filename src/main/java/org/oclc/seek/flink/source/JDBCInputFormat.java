...
public class JDBCInputFormat<OUT extends Tuple> extends RichInputFormat<OUT, InputSplit> implements NonParallelInput {
    ...
    public JDBCInputFormat<OUT> open() throws IOException {
        open(null);
        return this;
    }
    ...
    public void extractTypes(OUT tuple) throws SQLException, IOException {
     ...
     */
    public void addValue(OUT reuse) throws IOException, SQLException {
        for (int pos = 0; pos < columnTypes.length; pos++) {
            try {
